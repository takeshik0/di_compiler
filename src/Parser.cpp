...
int Parser::precedence(const Token& op) {
...
std::vector<Token> Parser::shoutingYard(std::vector<Token>& expression) {
...
std::vector<Token> Parser::parseExpression(std::vector<Token>& tokenList) {
